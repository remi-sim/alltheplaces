...
class AbeilleAssuranceFRSpider(SitemapSpider, StructuredDataSpider):
    name = "abeille_assurance_fr"
    item_attributes = {"brand": "Abeille Assurance", "brand_wikidata": "Q117012137"}
